    ...
    return (
        <div className="container-lg">
            ...
            <p className="desc">
                ...
                <p className="desc">While gaining popularity in a younger demographic, crochet e-commerce is old-fashioned, often requiring extensive research to begin the hobby
            ...
            <div className="row">
                ...
                <div className="col-md-12">
                    <p className="desc">Through my research and personal experience starting crochet, I developed one primary user: a young hobbyist starting crochet with a specific
                ...
                <div className="row">
                    <div className="col-md-12">
                        <p className="desc">To approach this issue, I centered Crochique around customizable crochet kits, 
                        ...
                        <p className="desc">With my biggest reference being crochet blogs, I knew Crochique needed to 
                        ...
                        <p className="desc">I started with an analogous scheme of five colors, reminiscent of feminine 
                ...
                <div className="row">
                    <div className="col-md-12 mt-4">
                        <p className="desc">As I refined the prototype and increased fidelity, I saw the need
                ...
                <div className="row">
                    <div className="col-md-12 mt-4">
                        <p className="desc">As I moved into testing, the biggest usability conflicts were 
                ...
                <div className="row">
                    <div className="col-md-12 mt-4">
                        ...
                        <p className="desc">All “user content” photos are from Unsplash.</p>

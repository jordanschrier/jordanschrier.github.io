            ...
            <div className="row">
                <div className="col-md-12">
                    ...
                    <div className="col mb-4">
                        <p className="work-description">Crochique, a conceptual mobile e-commerce site, aims to increase accessibility to the crocheting hobby through modularized design and a customizable kit-building interface.</p>
                        <div>
                            <img loading="lazy" src={images.crochique.steps} className="work-image img-fluid" alt="Crochique UI kit-building interface"></img>
                        </div>
                    </div>
                    <p className="work-description">With the onset of the COVID-19 lockdown and rise in popularity of apps like
                        TikTok, people were eager to learn and share new hobbies. According to <a href="https://www.forbes.com/sites/loisaltermark/2020/03/27/knitting-has-become-the-cool-activity-during-the-coronavirus-crisis/">this Forbes article</a>
                        , a particular knitting company saw a 75% sales increase each week during the pandemic.
                    </p>
                    <p className="work-description">While gaining popularity in a younger demographic, crochet e-commerce is old-fashioned, often requiring extensive research to begin the hobby
                        ...
                        they need, while standalone sites are specialized and expensive.</p>
                </div>
            </div>
            <div className="row">
                <div className="col mb-4">
                ...
                <div className="col-md-12">
                    <p className="work-description">Through my research and personal experience starting crochet, I developed one primary user: a young hobbyist starting crochet with a specific
                        ...
                        student picking up a new hobby they aren't yet committed to.</p>
                    <div className="col mb-4">
                        <div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <p className="work-description">To approach this issue, I centered Crochique around customizable crochet kits, 
                            ...
                            My biggest design goal was modularity, keeping the site approachable and concise.</p>
                        <p className="work-description">With my biggest reference being crochet blogs, I knew Crochique needed to 
                            feel friendly and community-based. I also studied the interfaces of Pinterest, Reddit, and 
                            Instagram since some sort of feed/post interface would be integral to that feeling.</p>
                        <p className="work-description">I started with an analogous scheme of five colors, reminiscent of feminine 
                            crochet blogs, but bolder and modernized.</p>
                    </div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    <div className="col-md-12 mt-4">
                        <p className="work-description">As I refined the prototype and increased fidelity, I saw the need
                        ...
                        <p className="work-description">As I moved into testing, the biggest usability conflicts were 
                ...
                <div className="row">
                    <div className="col-md-12 mt-4">
                        <p className="work-description">To solve this, I utilized icons to communicate each component of the
                        ...
                        <p className="work-description">Imagery was another big challenge, as free-use images of crochet 
                            products are few and far between. I found <a href="https://grabcad.com/library/ergonomic-crochet-hook-1">
                        ...
                        <p className="work-description">For some of the kit/product thumbnails, I used Photoshop to insert
                        ...
                        <p className="work-description">All “user content” photos are from Unsplash.</p>
                        <p className="work-description">To tie everything together, I used <a href="https://www.noiseandgradient.com/?chaos=0.1&colors=%23ed625d-%2342b6c6-%23f79f88-%23b2dfe6-%2303232d&grain=0.1">

    ...
    <div className="container-lg pt-6">
      <div className="row">
        ...
        <div className="col-md-6 py-3">
          <Link to="/advisa">
            <div className="ratio ratio-4x3 thumbnail">
              <img src={images.advisa.thumbnail} className="img-fluid home" alt="Greenway Gallery Thumbnail"></img>
              <img src={images.advisa.hover} className="img-fluid home overlay" alt="Greenway Augmented Reality Demo"></img>
            </div>
          </Link>
          <h2 className="pt-3">Advisa</h2>
          <div className="tag-container">

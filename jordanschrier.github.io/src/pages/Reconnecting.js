    ...
    return(
        <div className="container-lg">
            <div className="row">
                <div className="col-md-12">
                    ...
                    <div className="col-8 mb-4">
                        <p className="work-description">Connect Lehigh is a recently launched campus dashboard focused on customization, serving as a hub for the entire campus community.</p>
                        <p className="work-description">Our project, Reconnecting Lehigh, is a conceptual redesign of the university's existing site,
                    ...
                    <p className="work-description">Common anecdotes on the website are both visual and functional, with many embedded iFrames, lack of visual graphics,
            ...
            <div className="row">
                ...
                <div className="col-md-12">
                    <p className="work-description">We developed personas based on the main categories of users on the site, honing in on students (who may or may not be work-study employees) and faculty.</p>
                    <div className="col mb-4 d-flex justify-content-center">
                        <div>
            ...
            <div className="row">
                <div className="col-md-12">
                    <p className="work-description">To reorganize the information and keep the merit of a customizable portal, I developed
